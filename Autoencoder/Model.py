...
train_noisy_set = data.read_from_folder('../DFFCinput/noisy')
train_perfect_set = data.read_from_folder('../DFFCinput/perfect')
test_set = data.read_from_folder('../DFFCinput/noisy')
